  ...
  return createPortal(
    <div className="fixed inset-0 flex items-center justify-center bg-black/85 z-[1000]">
      <div
        ...
        className="animate-in zoom-in-70 duration-500 w-full md:min-w-[550px] max-h-[75vh] my-2 md:max-w-fit max-w-[95vw] bg-gray-100 rounded-lg py-4 relative overflow-y-auto zoom-out-125"
      >
        {!noClose && (
          <button
            onClick={toggleModal}
